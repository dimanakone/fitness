...
var _coachesSlider = require("./modules/coaches-slider");
var _reviewsSlider = require("./modules/reviews-slider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // ---------------------------------
  (0, _tabs.onTabClick)();
  (0, _video.onPlayVideoClick)();
  (0, _coachesSlider.getCoachesSlider)();
  (0, _reviewsSlider.getReviewsSlider)();
...
},{"./modules/coaches-slider":2,"./modules/form-validate/form":4,"./modules/modals/init-modals":10,"./modules/reviews-slider":12,"./modules/tabs":13,"./modules/video":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCoachesSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var getCoachesSlider = function getCoachesSlider() {
  if (document.querySelector('.coaches__swiper')) {
    var coachesSwiper = document.querySelector('.coaches__swiper');
    var coachesSwiperWrapper = document.querySelector('.coaches__swiper-wrapper');
    var coachesButtons = document.querySelectorAll('.coaches__button');
    coachesSwiper.classList.remove('coaches__swiper--nojs');
    coachesSwiperWrapper.classList.remove('coaches__swiper-wrapper--nojs');
    coachesButtons.forEach(function (coachesButton) {
      coachesButton.classList.remove('coaches__button--nojs');
    });

    // eslint-disable-next-line no-unused-vars,no-undef
    var swiper = new _swiper.default('.coaches__swiper', {
...
exports.getCoachesSlider = getCoachesSlider;

},{"../vendor/swiper":19}],3:[function(require,module,exports){
"use strict";
...
exports.getReviewsSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var getReviewsSlider = function getReviewsSlider() {
  if (document.querySelector('.reviews__swiper')) {
    var reviewsSwiper = document.querySelector('.reviews__swiper');
    var reviewsSwiperWrapper = document.querySelector('.reviews__swiper-wrapper');
    ...
    reviewsButtons.forEach(function (feedbackButtons) {
      feedbackButtons.classList.remove('reviews__button--nojs');
    });
    // eslint-disable-next-line no-unused-vars,no-undef
    var swiper = new _swiper.default('.reviews__swiper', {
      direction: 'horizontal',
      loop: false,
      slidesPerView: 1,
      spaceBetween: 40,
...
exports.getReviewsSlider = getReviewsSlider;

},{"../vendor/swiper":19}],13:[function(require,module,exports){
"use strict";
...
exports.onPlayVideoClick = onPlayVideoClick;
